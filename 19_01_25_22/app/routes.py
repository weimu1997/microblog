...
def index():
    ...
    return render_template("index.html", title="个人主页", form=form, posts=posts.items, next_url=next_url, prev_url=prev_url)
...
def user(username):
    ...
    return render_template("user.html", title="主页", user=user, posts=posts.items, next_url=next_url, prev_url=prev_url)
...
def explore():
    ...
    return render_template("explore.html", title="热点", posts=posts.items,
